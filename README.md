...
```groovy
compile "co.bitpesa.sdk:bitpesa-sdk-java8:0.2.1-SNAPSHOT"
```
...
* `target/bitpesa-sdk-java8-0.2.1-SNAPSHOT.jar`
* `target/lib/*.jar`
...
You can find examples in the `examples` directory on the features required by the [Onboarding documentation](https://github.com/bitpesa/api-documentation/blob/master/quick-integration.md)
